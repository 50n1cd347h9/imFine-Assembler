...
fn ImFineAssembler() type {
    return struct {
        ...
        fn init(_allocator: std.mem.Allocator) Self {
            ...
            return Self{
                ...
                .tokens = undefined,
                .curr_line_code = undefined,
                .codes = undefined,
                .label_addr = undefined,
                .label_slots = undefined,
                .out_buf = undefined,
                .label_idx = 0,
            };
        }
        ...
        pub fn parseArgs(self: *Self, args_p: *const [][:0]u8) !void {
            if (args_p.len < 2) {
        ...
        fn asignOutputName(self: *Self) void {
        ...
        fn getLabelIdx(self: *Self, label: []const u8) ?u128 {
        ...
        fn submitLabel(self: *Self, label: []u8) !void {
        ...
        fn resoluteLabelAddr(self: *Self, idx: u128, addr: usize) void {
            self.label_addr.items[@intCast(idx)].addr_abs = @intCast(addr);
        }

        fn getLabelAddr(self: *Self, idx: u128) ByteWidth {
        ...
        fn writeAddr(self: *Self, slot_place: ByteWidth, value: ByteWidth) void {
        ...
        fn resoluteLabelSlots(self: *Self) !void {
...
pub fn main() !void {
    ...
    var assembler = ImFineAssembler().init(allocator);
